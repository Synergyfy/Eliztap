                ...
                <div className="bg-linear-to-br from-primary via-blue-600 to-indigo-700 rounded-4xl p-8 md:p-12 text-white relative overflow-hidden shadow-2xl shadow-primary/30 group">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-blue-50 text-base md:text-lg max-w-sm mb-8 font-medium leading-relaxed opacity-90">
                                Visit participating venues and tap your phone at the EntryConnect terminal to earn instantly.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <button
                                    onClick={() => setShowIdModal(true)}
                                    className="bg-white text-primary px-8 py-4 rounded-2xl font-black text-sm shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all active:scale-95 flex items-center justify-center gap-3"
                                >
                                    <Scan size={20} />
                                    Show My Digital ID
                                </button>
                                <Link
                                    ...
                                    className="bg-primary-hover/30 text-white border border-white/20 px-8 py-4 rounded-2xl font-black text-sm backdrop-blur-sm hover:bg-white/10 transition-all flex items-center justify-center gap-2"
                                >
                                    Browse Perks
                                    <ArrowRight size={18} />
                                </Link>
                        ...
                        <div
                            onClick={() => setShowIdModal(true)}
                            className="bg-white p-6 rounded-[2.5rem] shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-500 cursor-pointer hover:scale-105 active:scale-95"
                        >
                            <div className="relative">
                                <QrCode size={140} className="text-text-main" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-3 bg-white p-8 rounded-4xl border border-gray-100 shadow-sm">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <Link href="/customer/history" className="px-4 py-2 bg-gray-50 text-xs font-black uppercase tracking-widest text-primary hover:bg-primary/5 rounded-xl transition-all">View All</Link>
                        </div>
                        <div className="space-y-2">
                            {recentVisits.map((visit) => {
                                const IconComponent = visit.icon;
                                return (
                                    <div key={visit.id} className="flex items-center justify-between p-4 hover:bg-gray-50 rounded-2xl transition-all cursor-pointer group border border-transparent hover:border-gray-100">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center text-text-secondary group-hover:bg-white group-hover:shadow-sm transition-all">
                    ...
                    <div className="lg:col-span-2 bg-white p-8 rounded-4xl border border-gray-100 shadow-sm">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-5 rounded-[1.5rem] bg-gray-50/50 border border-gray-100 relative group overflow-hidden">
                            ...
                            <div className="p-5 rounded-[1.5rem] bg-white border-2 border-primary/20 shadow-lg shadow-primary/5 relative group overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <button
                                        ...
                                        className="w-full h-11 bg-primary text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-primary-hover shadow-lg shadow-primary/20 transition-all active:scale-95 flex items-center justify-center gap-2"
                                    >
                                        Claim Reward Now
