...
export default function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const [activeTab, setActiveTab] = React.useState<'specs' | 'downloads' | 'details' | 'video' | 'howto'>('specs');
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-0">
            {/* Header */}
            ...
            <main className="max-w-[1400px] mx-auto px-4 md:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        <div className="aspect-square bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden relative group shadow-sm">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            {product.images.map((img: string, i: number) => (
                                <button
                                    ...
                                    className={`aspect-square rounded-2xl border-2 overflow-hidden bg-white dark:bg-slate-900 hover:opacity-100 transition-all ${selectedImage === i ? 'border-primary opacity-100 shadow-lg shadow-primary/10' : 'border-slate-200 dark:border-slate-800 opacity-60 hover:border-slate-300'}`}
                                >
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        {/* Price Breakdown */}
                        <div className="bg-slate-100 dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3">
                        ...
                        <div className="flex flex-col gap-4 pt-4">
                            <div className="flex items-center gap-4">
                                <div className="flex items-center border border-slate-300 dark:border-slate-700 rounded-xl h-14 bg-white dark:bg-slate-900">
                                    <button
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-primary hover:bg-orange-700 text-white font-bold h-14 rounded-xl shadow-lg shadow-primary/25 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                                >
                            ...
                            <button
                                ...
                                className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold py-4 rounded-xl hover:opacity-90 transition-all active:scale-[0.98]"
                            >
                                Request Bulk Quote
                            </button>
                        </div>
                ...
                <div className="mt-20 grid grid-cols-1 lg:grid-cols-12 gap-12">
                                    ...
                                    <div className="grid gap-4">
                                        {product.documents?.map((doc: any, i: number) => (
                                            <div key={i} className="flex items-center justify-between p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-primary transition-all cursor-pointer group shadow-sm">
                                                <div className="flex items-center gap-4">
                                                    <div className={`p-3 rounded-xl ${doc.type === 'sdk' ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600' : 'bg-orange-50 dark:bg-orange-900/30 text-orange-600'}`}>
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div className="bg-slate-50 dark:bg-slate-900/40 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 sticky top-28">
                            ...
                            <div className="mt-8 bg-linear-to-br from-primary to-orange-700 rounded-2xl p-6 text-white shadow-xl shadow-primary/20">
                                ...
                                <button
                                    ...
                                    className="bg-white text-primary px-4 py-3 rounded-xl font-bold text-sm w-full hover:bg-orange-50 transition-colors shadow-lg"
                                >
                                    Book a Consultation
                                </button>
                            </div>
