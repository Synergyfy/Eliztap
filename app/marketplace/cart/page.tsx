...
import {
    ...
    ChevronLeft, Plus, Minus, Check, X, CreditCard, MapPin, Truck
} from 'lucide-react';
...
export default function CartPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans text-slate-900 pb-20">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-2">
                        <div className="bg-black text-white p-2 rounded-lg">
                            <span className="font-bold text-lg tracking-tighter">Cr</span>
                        </div>
                    </Link>

                    <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-500">
                        <Link href="/" className="text-black font-bold flex flex-col items-center gap-1 group">
                            Home
                    ...
                    <div className="flex items-center gap-6">
                        <div className="relative">
                            ...
                            {items.length > 0 && (
                                <span className="absolute -top-2 -right-2 bg-red-500 text-white text-[10px] w-4 h-4 flex items-center justify-center rounded-full font-bold border-2 border-white">
                                    {items.length}
                                </span>
                            )}
                        </div>
                        <div className="w-8 h-8 rounded-full bg-linear-to-tr from-cyan-200 to-blue-200 border border-white shadow-sm overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto w-full pt-12 pb-12 px-4">
                <div className="flex items-center justify-between relative">
                    ...
                    {['Cart', 'Address', 'Payment'].map((s, index) => {
                        ...
                        return (
                            <div key={s} className="flex flex-col items-center gap-2 bg-gray-50 px-4 cursor-pointer" onClick={() => step > stepNum && setStep(stepNum)}>
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-all ${isActive ? 'bg-black border-black text-white' : 'bg-white border-gray-200 text-gray-400'}`}>
                                    {step > stepNum ? <Check size={14} /> : stepNum}
                                </div>
                                <span className={`text-xs font-bold uppercase tracking-wider transition-colors ${isCurrent ? 'text-black' : 'text-gray-400'}`}>{s}</span>
                            </div>
                        );
                    })}
                </div>
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
                            ...
                            <>
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-xs font-bold text-gray-400 space-x-4">
                                        <button className="hover:text-black transition-colors">Move to wishlist</button>
                                        ...
                                        {items.length > 0 ? (
                                            items.map((item) => (
                                                <div key={item.id} className="p-6 flex gap-6 group hover:bg-gray-50/50 transition-colors relative">
                                                    <div className="w-32 h-24 bg-gray-100 rounded-xl flex items-center justify-center overflow-hidden shrink-0">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="flex items-center justify-between mt-auto">
                                                            ...
                                                            <div className="flex items-center bg-white border border-gray-200 rounded-lg h-9 overflow-hidden">
                                            ...
                                            <div className="text-center py-20 px-4">
                                                ...
                                                <Link href="/marketplace" className="inline-flex items-center gap-2 px-6 py-3 bg-black text-white rounded-xl font-bold hover:opacity-90 transition-opacity shadow-lg shadow-gray-200">
                            ...
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-black/5 transaction-all font-medium"
                                ...
                                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        {['card', 'transfer', 'crypto'].map((method) => (
                                            <label key={method} className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${paymentMethod === method ? 'border-black bg-gray-50' : 'border-gray-100 hover:border-gray-200'}`}>
                                                <input
                                                    type="radio"
                                                    name="payment"
                                                    className="hidden"
                                                ...
                                                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${paymentMethod === method ? 'border-black' : 'border-gray-300'}`}>
                                                    {paymentMethod === method && <div className="w-2.5 h-2.5 bg-black rounded-full" />}
                                                </div>
                    ...
                    <div className="w-full lg:w-[400px] space-y-8 shrink-0">
                        ...
                        {/* Summary Card */}
                        <div className="bg-white rounded-3xl p-8 space-y-4 border border-gray-100 shadow-sm sticky top-32">
                            ...
                            {items.length > 0 && (
                                <div className="flex -space-x-3 overflow-hidden py-2 mb-4">
                                    {items.slice(0, 4).map((item) => (
                                        <div key={item.id} className="w-10 h-10 rounded-full border-2 border-white bg-gray-100 flex items-center justify-center overflow-hidden">
                                            <img src={item.image} alt={item.name} className="w-full h-full object-cover" />
                                        </div>
                                    ))}
                                    {items.length > 4 && (
                                        <div className="w-10 h-10 rounded-full border-2 border-white bg-gray-900 text-white text-xs font-bold flex items-center justify-center">
                                            +{items.length - 4}
                                        </div>
                                    )}
                                </div>
                            ...
                            {step === 1 && (
                                <>
                                    <div className="pt-6">
                                        ...
                                        <div className="bg-gray-50 p-1.5 rounded-xl border border-gray-200 flex shadow-sm mb-4">
                                            <input
                                                type="text"
                                            ...
                                            />
                                            <button onClick={handleApplyCoupon} type="button" className="px-5 py-2 bg-white border border-gray-200 hover:bg-gray-50 text-black rounded-lg font-bold text-xs transition-colors uppercase tracking-wide shadow-sm">
                                                Apply
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    {/* Gifting logic */}
                                    <div
                                        className={`p-4 rounded-xl border transition-all cursor-pointer flex items-center gap-4 group mb-4 ${isGift ? 'bg-indigo-50 border-indigo-200' : 'bg-gray-50 border-gray-200 hover:border-gray-300'}`}
                                        onClick={toggleGift}
                                    >
                                        ...
                                        <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${isGift ? 'bg-indigo-600 border-indigo-600' : 'bg-white border-gray-300'}`}>
                            ...
                            <button
                                ...
                                className="w-full bg-black text-white h-14 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-gray-800 transition-all shadow-xl shadow-gray-200 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed mt-6"
                            >
