...
export default function HowItWorks() {
    const steps = [
        ...
        },
        {
            ...
            description: 'Position your LaTap NFC tags at strategic walk-in points—receptions, tables, or checkout counters.',
            icon: 'nfc'
        },
        {
            number: '03',
                ...
                <section className="pb-24 px-4 sm:px-6 lg:px-8 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl text-text-secondary font-medium leading-relaxed max-w-2xl mx-auto">
                            LaTap uses NFC technology to eliminate the friction in customer interactions. Here is how we help you capture every visitor.
                        </p>
                    </div>
                </section>
